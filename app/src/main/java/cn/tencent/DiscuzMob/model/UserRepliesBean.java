...
public class UserRepliesBean {
    ...
    public static class VariablesBean {
         ...
         * member_avatar : https://ucenter.nf12.com/avatar.php?uid=32&size=small
         * groupid : 10
         * formhash : f412cd25
         * ismoderator : null
         * readaccess : 15
